...
//About Page Pop Up
			...
			$(document).ready(function(){
				...
				$("#popupAbout").css({
					...
					centerPopupAbout();
					loadPopupAbout();
				    $("#popupAbout").mCustomScrollbar("vertical",1,"easeOutCirc",1.05,"auto","yes","yes",10);	
				});
...
//Projects Page Pop Up
			...
			$(document).ready(function(){
				...
				$("#popupProjects").css({
					...
					centerPopupProjects();
					loadPopupProjects();
				    $("#popupProjects").mCustomScrollbar("vertical",1,"easeOutCirc",1.05,"auto","yes","yes",10);						
				});
...
//Contact Page Pop Up
			...
			$(document).ready(function(){
				...
				$("#popupContact").css({
					...
					centerPopupContact();
					loadPopupContact();
				    $("#popupContact").mCustomScrollbar("vertical",1,"easeOutCirc",1.05,"auto","yes","yes",10);						
				});
...
//Blog Page Pop Up
			...
			$(document).ready(function(){
				...
				$("#popupBlog").css({
					...
					centerPopupBlog();
					loadPopupBlog();
				    $("#popupBlog").mCustomScrollbar("vertical",1,"easeOutCirc",1.05,"auto","yes","yes",10);						
				});
